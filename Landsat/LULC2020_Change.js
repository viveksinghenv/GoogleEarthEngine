...
var gaul = ee.FeatureCollection("FAO/GAUL_SIMPLIFIED_500m/2015/level2"),
    ...
    ee.Geometry.Polygon(
        [[[85.65497981423793, 24.160417215918233],
          [85.65497981423793, 23.646919652638765],
          [86.79069148415981, 23.646919652638765],
          [86.79069148415981, 24.160417215918233]]], null, false),
    farms1 = ee.FeatureCollection("projects/landsat-325606/assets/LULC2020_change_6May");
...
// var DEM = DEM.select('DSM')
var slope =  ee.Terrain.slope(DEM/*.mosaic()*/);
// Map.addLayer(slope)
...
var mean = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2')
    ...
    .select(['SR_B1','SR_B2','SR_B3','SR_B4','SR_B5','SR_B6','SR_B7','ST_B10'],['coastal','blue','green','red','nir','swir1','swir2','tir'])
    .map(scaleC3).median();
/************NBLI*******/  
...
Export.table.toDrive({
  collection: fc,
  description: 'Accuracy_Export2020',
  folder: 'Change_Interpretation',
  fileNamePrefix: 'accuracy2020_n',
  fileFormat: 'CSV'
})
Export.image.toDrive({
  image: classified,
  description: 'Landsat_2020_n',
  folder: 'Change_Interpretation',
  scale: 30,
  maxPixels: 1e9,
  region: dhn
