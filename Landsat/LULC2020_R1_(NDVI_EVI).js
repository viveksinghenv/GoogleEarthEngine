...
var farms1 = ee.FeatureCollection("projects/landsat-325606/assets/Rev_LULC_pts2022"),
    ...
    ee.Geometry.Polygon(
        [[[85.97946153443442, 23.9894535502592],
          [85.97946153443442, 23.723190253520787],
          [86.50199876587973, 23.723190253520787],
          [86.50199876587973, 23.9894535502592]]], null, false);
...
var mean = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2')
    ...
    .filterDate('2019-04-01', '2020-03-30')
    .filter(ee.Filter.lt("CLOUD_COVER", 5))
    .select(['SR_B1','SR_B2','SR_B3','SR_B4','SR_B5','SR_B6','SR_B7'],['coastal','blue','green','red','nir','swir1','swir2'])
    .map(scaleC2).median();
